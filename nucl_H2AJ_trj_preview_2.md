### N<sub>H2A.J</sub><sup>run_2</sup> - Nucleosome with H2A.J with full tails (PDB ID 5AV9)
...
<script>
  var pdb="trj/nucl_H2AJ_for_web_2.pdb"
  var xtc="trj/nucl_H2AJ_for_web_2.xtc"
  var csvfile="dat/H2AJ_dist_unwrap_2.csv"
  var trjstep = 10;
